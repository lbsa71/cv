...
export function generateHTML(data: TransformedCVData, config: Config, privatize: boolean = false): void {
  console.log("\n=== generateHTML: Starting HTML generation ===");
  if (privatize) {
    console.log("🔒 Privatize mode: Email and phone will be excluded from HTML");
  }
...
`;
  ...
  console.log("HTML generated and downloaded successfully!");
}
